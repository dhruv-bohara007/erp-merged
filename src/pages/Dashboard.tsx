...
const Dashboard = () => {
  ...
  const stats = showSampleData ? sampleStats : {
    totalRevenue: 0,
    totalInvoices: 0,
    totalClients: 0,
    growthRate: 0
  ...
  const revenueData = showSampleData ? sampleRevenueData : [];
  const invoiceStatusData = showSampleData ? sampleInvoiceStatusData : [];
