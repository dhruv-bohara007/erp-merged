...
const PurchaseRequestsAdmin = () => {
  ...
  const [activeSection, setActiveSection] = useState('purchase-requests'); // Default to purchase-requests
      ...
      <Card>
        ...
        <CardContent>
          <div className="py-12 text-center">
            ...
            <p className="text-gray-500">Purchase orders will appear here once created.</p>
          </div>
        </CardContent>
      </Card>
    </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage purchase requests and orders</p>
          </div>
          
          <div className="flex bg-gray-100 rounded-lg p-1">
            <button
              onClick={() => setActiveSection('purchase-requests')}
